...
//
const BotName = 'ANARGA BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/badboyz.skyz'; // Nama Instagramlu cok
const whatsapplu = '0857-0092-5421'; // Nomor whatsapplu cok
